...
/* - @todo Перейти на новое пространстов имён. Сейчас deprecated-сообщения подавлены в самом boost.
...
namespace json
{
    ...
    protected:
        ...
        struct push_string
        {
            ...
            void operator() (Iterator szStart, Iterator szEnd) const
            {
                ...
                // 2: traverse through the original std::string and check for escape codes..

                std::basic_string< typename Iterator::value_type > strString;

                while(szStart < szEnd)
                {
                    // 2.1: if it's no escape code, just append to the resulting std::string...
                ...
                // 3: finally, push the std::string on the stack...
        ...
        struct push_boolean
        {
            ...
            void operator() (Iterator szStart, Iterator /* szEnd */ ) const
            {
                // 1: push a boolean that is "true" if the std::string starts with 't' and "false" otherwise...
    ...
    public:
        ...
        class definition
        {
            boost::spirit::rule< SCANNER > m_object_or_array;
        ...
        public:
            ...
            boost::spirit::rule< SCANNER > const & start() const { return m_object_or_array; }
            ...
            definition(grammar const & self)
            {
                ...
                m_object_or_array = m_object | m_array;
                ...
                // 4: a value can be a std::string in double quotes, a number, a boolean, an object or an array.
                ...
                // 5: a std::string is a collection of zero or more unicode characters, wrapped in double quotes...
